...
local ThemeManager = loadstring(game:HttpGet("https://raw.githubusercontent.com/FancySans/FancyTale/main/ThemesV2"))()
local SaveManager = loadstring(game:HttpGet(repo .. 'addons/SaveManager.lua'))()

local Window = Library:CreateWindow({
  Title = "Shibahub.cc | V3.4 | Build: Dev Rewrite",
  Center = true,
  AutoShow = true,
  TabPadding = 8,
  MenuFadeTime = 0.2
...
ArmVisTab:AddToggle('ArmChams', { Text = 'enabled', Default = false }):AddColorPicker('ArmChamsColor', { Default = Color3.fromRGB(255, 255, 255), Title = 'Color' }):OnChanged(function(Value)
if Value == true then
elseif Value == false then
setArmProperties("Color", Color3.fromRGB(255, 255, 255))
...
SilentTab:AddToggle('Snapline',{Text='snaplines',Default=false}):AddColorPicker('SnaplineColor',{Default=Color3.fromRGB(255, 255, 255),Title='Color'})
SilentTab:AddToggle('Snapcircles',{Text='snapcircles',Default=false}):AddColorPicker('SnapcirclesColor',{Default=Color3.fromRGB(255, 255, 255),Title='Color'}):OnChanged(function(Value)
...
FovTab:AddToggle('Fov',{Text='enabled',Default=false}):AddColorPicker('FovColor',{Default=Color3.fromRGB(255, 255, 255),Title='Color'})
FovTab:AddToggle('Dynamic',{Text='dynamic',Default=true})
FovTab:AddToggle('FovHighlight',{Text='highlight',Default=false}):AddColorPicker('FovHighlightColor',{Default=Color3.fromRGB(255, 255, 255),Title='Color'})
...
PlayerVisualTab:AddToggle("Tracer", { Text = "Tracer", Default = false })
	:AddColorPicker("TracerColor", { Default = Color3.fromRGB(255,255,255), Title = "Color" })
...
local SkinChangerTabBox = Tabs.Credits:AddRightTabbox('skinbox')
...
local FieldOfViewTabBox = Tabs.Credits:AddRightTabbox('field of view')
...
local HUDTabBox = Tabs.Credits:AddRightTabbox('HUD')
...
local CustomCharTabBox = Tabs.Credits:AddLeftTabbox('custom character')
...
--* Viewmodel *--
local CustomViewmodelTabBox = Tabs.Credits:AddLeftTabbox('custom viewmodel')
...
local Chats = {
["Shibahub.cc"] = {"Ez Beamed, Get better and get Shibahub"};
}
...
if Trashtalk and tonumber(finalHealth) <= 0 then
  _Network.Send(_SendCodes.SEND_CHAT_MESSAGE, extractedName .. " killed from " .. studsValue .. "m, " .. Chats["Shibahub.cc"][math.random(1, #Chats["Shibahub.cc"])] .. "", "Global")
end
end
end)
...
TrashTalkTab:AddInput('ChatSpammer', {Default = "Shibahub.cc On Top", Numeric = false, Finished = true, Text = 'chat spammer:', Placeholder = "Chat Spam Custom Text [HERE]"}):OnChanged(function(value)
chatSpammerText = value
end)

local CustomSkyTabBox = Tabs.World:AddLeftTabbox('lighting')
...
local RightGroupBox = Tabs.Misc:AddRightGroupbox('Freecam')
RightGroupBox:AddLabel('Freecam - B')
loadstring(game:HttpGet("https://pastebin.com/raw/9x5YxWXV", true))();


local TabBox = Tabs.Misc:AddRightTabbox()
local MiscTab = TabBox:AddTab('Extra')





ExploitsTab:AddToggle('', {Text = "Jump Crouch",Default = false,}):AddKeyPicker('JumpCrouchKey', {Default='Non',SyncToggleState=true,Mode='Toggle',Text='Jump Crouch',NoUI=false})
local stoprun = false
task.spawn(function()
while true do
...
local WorldEspTabBox = Tabs.World:AddRightTabbox('world esp')
...
local WatermarkConnection = game:GetService('RunService').RenderStepped:Connect(function()
    ...
    Library:SetWatermark(("Shibahub.cc | Version 3.4 | Build: Developer Rewrite | Game: Trident Survival | %s fps | %s ms"):format(
        math.floor(FPS),
...
MenuGroup:AddLabel('Made by GenoAnimations', true)
...
ThemeManager:SetFolder('Shibahub.cc')
SaveManager:SetFolder('Shibahub/Trident')
...
wait(0)Library:Notify("Thanks For Using [Shibahub.cc]")


loadstring(game:HttpGet("https://pastebin.com/raw/7i0ZNEJx", true))();
